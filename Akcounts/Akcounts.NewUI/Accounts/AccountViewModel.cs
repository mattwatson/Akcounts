...
namespace Akcounts.NewUI.Accounts
{
    public class AccountViewModel : Screen
    {
        ...
        private ObservableCollection<AccountTagViewModel> _accountTags;
        ...
        private void RebuildVisibleTransactionList()
        {
            ...
            NotifyOfPropertyChange(() => AccountTransactionViewModels);
            RefreshBalances();
        }

        private void RefreshBalances()
        {
            NotifyOfPropertyChange(() => BalanceExFuExUv);
            NotifyOfPropertyChange(() => BalanceExFuInUv);
            NotifyOfPropertyChange(() => BalanceInFuExUv);
            NotifyOfPropertyChange(() => BalanceInFuInUv);
        }
        ...
        public string AccountName
        {
            ...
            set
            {
                ...
                NotifyOfPropertyChange(() => EditingName);
                NotifyOfPropertyChange(() => NotEditingName);
            }
        }
        ...
        public string AccountTypeName
        {
            ...
            set
            {
                ...
                if (TryParseAccountType(value, out type))
                {
                    ...
                    NotifyOfPropertyChange(() => AccountTypeName);
                }
            }
        }
        ...
        public bool IsEnabled
        {
            ...
            set
            {
                ...
                NotifyOfPropertyChange(() => EnableButtonText);
            }
        }
        ...
        public void RemoveAccountTag(object sender, EventArgs e)
        {
            ...
            _accountRepository.Save(_account);
            NotifyOfPropertyChange(() => AccountTags);
        }
